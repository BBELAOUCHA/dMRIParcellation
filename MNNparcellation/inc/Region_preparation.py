...
#     2.4 Excluded_label: add label (0) of the excluded seeds to the parcellated ones.
#     2.5 Write2file: function used to write some results in ./results.txt
#      at each iteration save in row way nbr of regions,time of execution, STD of SM
#####################################################################################
# BELAOUCHA Brahim
...
class Regions_processing():  # functions on the regions
    ...
    def Add_zero_tracto_label(self, check_tracto, Regions):
        ...
        for i in check_tracto.zero_tracto:  # add the label of void seeds
            ...
            # the label of void tractogram is the same as its nearest non void tracto
